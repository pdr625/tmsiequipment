...
// exw_price/currency/supplier_id/SAP codes are nullable here because
// tmsi.v_products (E3-0003/0004) nulls them for callers without
// can_read_costs() — this form only ever renders for
// canManageProducts() (admin/product_manager), which is always a subset
// of that, so they're really always non-null when it matters. The
// `?? ...` fallbacks below exist to satisfy the type, not because a
// manager should ever actually see them missing.
type Product = {
  id: string;
  name: string;
