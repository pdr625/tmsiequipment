...
// `tmsi.me()`, o mesmo pedido que decide se se vêem custos.

export async function GET() {
  const supabase = await createSupabaseServerClient();

  // 0021: identidade, direito a custos e nome numa só chamada (eram três).
  ...
  // ter segunda barreira. Passa a perguntar explicitamente (agora via me()); a
  // RLS de v_products continua por baixo.
  const seesCosts = me.can_read_costs === true;
